...
// 1004: v11.0  (adds BUILDING_FAITH_TO_SCIENCE, BUILDING_CITY_TILE_WORK_SPEED_MOD, BUILDING_HURRY_COST_MODIFIER, BUILDING_GROWTH_GOLD, BUILDING_SCIENCE_PER_X_POP, BUILDING_CULTURE_PER_X_ANCIENCT_BUILDING, BUILDING_NEAR_MOUNTAIN_YIELD_CHANGES, BUILDING_DOUBLE_DEFENSE_NEAR_MOUNTAIN, BUILDING_NO_HOLY_CITY_AND_NO_OCCUPIED_UNHAPPINESS, BUILDING_NEARBY_ENEMY_DAMAGE, CITY_EXTRA_HEAL, BUILDING_NAVAL_COMBAT_MODIFIER_NEAR_CITY, BUILDING_HAPPINESS_FOR_FILLED_GREAT_WORK_SLOT, BUILDING_FOOD_BONUS_IF_NO_CITIES_AROUND)
