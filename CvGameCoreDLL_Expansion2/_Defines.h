...
// 1010: v10.x  (adds POLICY_MAX_EXTRA_VOTES_FROM_MINORS, POLICY_EXTRA_VOTES, POLICY_DO_TECH_FROM_CITY_CONQ, POLICY_GOLDEN_AGE_YIELD_MOD, POLICY_BUILDING_SPECIALIST_COUNT_CHANGE, POLICY_NO_CULTURE_SPECIALIST_FOOD, POLICY_MINORS_GIFT_UNITS)
